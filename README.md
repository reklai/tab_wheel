...
- Drag current tab lets you hold the configured button and drag horizontally; every 100 px moves the active tab one slot without changing its pinned or group membership.
